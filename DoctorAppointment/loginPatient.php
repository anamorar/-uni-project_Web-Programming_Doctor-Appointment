...
<form method="post" action="patient/index.php">
    ...
    <div class="input-group">
        ...
        <p>
            Not a member? <a href="registerPatient.php">Sign Up</a>
        </p>
</form>
</body>
</html>
...
if (isset($_POST['Email']) && isset($_POST['Password'])) {
    ...
    ?>
    <form action="patient/index.php" id="f1">
        <?php
        // Validate email
        if (empty(trim($_POST["Email"]))) {
            ...
            $sql = "SELECT PatientID FROM patient WHERE Email = ?";
